...
<div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-plus"></i> Update Data Harga Rekanan</div>
        <div class="card-body">
          <div class="table-responsive">
             <div class="container">

        <form action="<?php echo config_item('base_url'); ?>/pengaturan/action_updatedataspj/<?= $data->id_ssh?>" method="post" enctype="multipart/form-data">
             ...
             <div class="form-group">
              <div class="form-row">
                  ...
                  <div class="col-md-6">
                    ...
                    <select class="form-control" name="Kelompok_spj" value="<?= $data->Kelompok_spj?>">
                      <option><?= $data->Kelompok_spj?></option>
              ...
              <div class="col-md-6">
                    ...
                    <input value="<?= $data->Jenisbarang_spj?>"class="form-control" id="Jenisbarang_spj" type="text" aria-describedby="nameHelp" name="Jenisbarang_spj" required/>
                  </div>
                           
                  <div class="col-md-6">
                    <label for="Ukuran_spj">Ukuran</label>
                    <input value="<?= $data->Ukuran_spj?>"class="form-control" id="Ukuran_spj" type="text" aria-describedby="nameHelp" name="Ukuran_spj" required/>
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-6">
                  ...
                  <div class="col-md-6">
                    <label for="Tahun_spj">Tahun spj</label>
                    <input value="<?= $data->Tahun_spj?>"class="form-control" id="Tahun_spj" type="text" aria-describedby="nameHelp" name="Tahun_spj" required/>
                  </div>
